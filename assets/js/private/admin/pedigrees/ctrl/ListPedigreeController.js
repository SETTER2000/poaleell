(function (angular) {
    ...
    angular.module('PedigreeModule')
        .controller('ListPedigreeController', ['$scope', '$location', 'moment', '$http', 'toastr', 'toastrConfig',
            "$rootScope", '$state', 'Pedigrees', '$mdDialog', '$window',
            function ($scope, $location, moment, $http, toastr, toastrConfig, $rootScope, $state, Pedigrees, $mdDialog) {
                ...
                $scope.urlBt = 'home.admin.pedigrees.create';
                ...
                $scope.help = {
                    dogsOnCatalog: 'Родословные собак питомника Poale Ell, а так же собак из других питомников.',
                };
                ...
                // $scope.tableView = "/js/private/admin/pedigrees/views/home.admin.pedigrees.table.html";
                // $scope.listView = "/js/private/admin/pedigrees/views/home.admin.pedigrees.list.html";
                // $scope.actionView = "/js/private/admin/pedigrees/views/home.admin.pedigrees.action.html";
                // $scope.workView = "/js/private/admin/pedigrees/views/home.admin.pedigrees.work.html";
                ...
                $scope.refresh = function (where) {
                    ...
                    $scope.items = Pedigrees.query($scope.query, function (pedigrees) {
                        // console.log('Pedigrees LIST:', pedigrees);
                        $scope.items = pedigrees;
                        $scope.countCurrentView = pedigrees.length;
                        $scope.objectName = pedigrees;


                    }, function (err) {
                        toastr.error(err.data.details, 'Ошибка 77881! ' + err.data.message);
                    });
                };
                ...
                breadcrumb.set('Pedigree', 'home.admin.pedigrees' + $state.current.url);
