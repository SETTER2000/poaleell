...
angular.module('VacationModule')
    .controller('EditVacationController', ['$scope', '$http', 'toastr', '$interval', '$state', 'Vacations', 'moment', 'Positions', 'Departments', '$stateParams', 'FileUploader', '$rootScope',
        function ($scope, $http, toastr, $interval, $state, Vacations, moment, Positions, Departments, $stateParams, FileUploader, $rootScope) {
            ...
            $scope.uploaderView = "/js/private/admin/vacations/views/uploader.html";
            ...
            //var item = $scope.item = Vacations.get({id: $stateParams.userId}, function (vacations) {
            $scope.refresh = function () {
                let item = $scope.item = Vacations.get({id: $stateParams.userId}, function (vacations) {
            ...
            $scope.changeMyPassword = function () {
                $http.put('/vacations/changePassword', {
                        id: $scope.item.id,
                    ...
                    /*  &&
                     ...
                     angular.isDefined(item.email)*/
                        ...
                        item.$save(item, function (success) {
                                ...
                                $state.go('home.admin.vacation', {userId: success.id});
                            },
                            function (err) {
