angular.module('DashboardModule').controller('EditProfileController', ['$scope', '$http', '$window', '$stateParams', 'Users', 'toastr', '$resource', '$rootScope',
    function ($scope, $http, $window, $stateParams, Users, toastr, $resource, $rootScope) {
        ...
        $scope.unexpected = 'Произошла непредвиденная ошибка: ';
        /////////////////////////////////////////////////////////////////////////////////
        ...
        //       $scope.editProfile.errorMsg = $scope.unexpected + (sailsResponse.data || sailsResponse.status);
        //     }
