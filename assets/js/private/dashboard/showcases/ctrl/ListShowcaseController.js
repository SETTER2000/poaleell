(function (angular) {
    ...
    angular.module('ShowcaseModule')
        .controller('ListShowcaseController', ['$scope', '$location', 'moment', '$http', 'toastr', "$rootScope", '$state', 'Showcases',  '$window', function ($scope, $location, moment, $http, toastr, $rootScope, $state, Showcases) {
            ...
            $scope.refresh = function (where) {
                ...
                $scope.items = Showcases.query($scope.query, function (users) {
            ...
            breadcrumb.set('Showcases', '/admin/' + $state.current.url);
